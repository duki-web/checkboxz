...
在`config.yml`文件里自行按照格式添加需要的任务,运行
   ```       
      git clone https://github.com/duki-web/checkboxz.git
...
```
ql repo https://github.com/duki-web/checkboxz.git "checkbox|install" "old" "modules|scripts|config|Template|sendmsg" "master"
```
